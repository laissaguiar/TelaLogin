...
public class TelaLogin {
     ...
     * For example purposes, it preloads the database with some sample user
     */
    public TelaLogin() {
     ...
     * @return {@code true} if authentication is successful, {@code false}
     *         otherwise.
     */
     ...
     * recommend for use in a production environment as it lacks proper security
     * measures.
     * 
